...
import path from 'path'; // ── Member → file mapping ──
...
export { assembleDeck, assemblePartyDeck, loadMemberDeck, listMembers, listParties, getPartyMembers, MEMBER_FILES, PARTY_MEMBERS };