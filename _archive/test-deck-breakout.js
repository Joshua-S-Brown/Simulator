...
import { assembleDeck, assemblePartyDeck, loadMemberDeck, listMembers, PARTY_MEMBERS } from './lib/deck-assembler.js';
let passed = 0;
let failed = 0;
...
//
import originalStandard from './data/decks/visitor-party-standard.js';
import originalArcane from './data/decks/visitor-party-arcane.js';
