/**
 * MEMBER DECK: Ranger (Arcane Expedition)
 * Role: Ranged DPS / Pressure / Deterrent — 10 cards
 *
 * Primary: Consistent structure damage with persistent effects (Erode)
 * Strengths: Piercing Arrow (3P+Erode), Nature's Snare deters Strikes, Siphon rewards team synergy
 * Weaknesses: No party protection, no healing/Fortify, only Physical/Environmental
 */
export default [
  // ── Energy (3) ──
